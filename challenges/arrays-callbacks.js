...
lowCaseAnimalNames = zooAnimals.map((a) => a.animal_name.toLowerCase());
...
lowPopulationAnimals = zooAnimals.filter((p) => p.population < 5);
...
console.log(consume("Cristina", "Altreche", greeting));
